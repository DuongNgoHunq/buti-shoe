...
class OutstandProduct extends Component {
    ...
    render() {
        ...
        return (
            <div className='section-share section-outstand-product  container-fluid'>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(OutstandProduct));
